import{u as A,Z as oe,ae as ge,gc as j,gd as fe,eE as G,ge as xe,j as e,F as x,A as N,aN as S,G as ye,a5 as se,a6 as ie,aY as be,L as ae,r as L,B as m,d as h,af as je,i as Ce,dA as we,m as J,n as Q,o as P,q as Z,T as f,s as X,t as Y,E as _,bu as ee,aQ as Te,I as te,w as ve,bB as $e,bn as ke}from"./strapi-C46Ei97l.js";import{u as D,a as re,g as u,A as Me,C as ne}from"./index-Knq4Ti8R-DH_cMcwa.js";import"./sortBy-DvDrIlAj.js";import"./groupBy-BTsmVF7-.js";import"./_baseEach-CkOrRFtO.js";import"./index-Bwxh6xae.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";import"./_baseMap-DbFXyUwq.js";const Fe=h(m)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,De=({component:t,dzName:n,index:o,isActive:s=!1,isInDevelopmentMode:r=!1,onClick:i})=>{const{modifiedData:p,removeComponentFromDynamicZone:b}=D(),{schema:{icon:y,displayName:g}}=j(p,["components",t],{schema:{}}),l=a=>{a.stopPropagation(),b(n,o)};return e.jsxs(Ae,{alignItems:"center",direction:"column",className:s?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:i,role:"tab",tabIndex:s?0:-1,cursor:"pointer","aria-selected":s,"aria-controls":`dz-${n}-panel-${o}`,id:`dz-${n}-tab-${o}`,children:[e.jsx(Ie,{icon:y,isActive:s}),e.jsx(m,{marginTop:1,maxWidth:"100%",children:e.jsx(f,{variant:"pi",fontWeight:"bold",ellipsis:!0,children:g})}),r&&e.jsx(ce,{tag:"button",onClick:l,children:e.jsx(ke,{})})]})},Re=h(S)`
  width: 3.2rem;
  height: 3.2rem;
  padding: 0.9rem;
...
`,Le=h(x)`
  ...
  align-items: center;
`,Ee=({customRowComponent:t,components:n=[],addComponent:o,name:s,targetUid:r})=>{const{isInDevelopmentMode:i}=D(),[p,b]=L.useState(0),{formatMessage:y}=A(),g=a=>{p!==a&&b(a)},l=()=>{o(s)};return e.jsx(le,{className:"dynamiczone-row",$isFromDynamicZone:!0,children:e.jsxs("td",{colSpan:12,children:[e.jsx(Be,{paddingLeft:8,children:e.jsxs(Ne,{gap:2,children:[i&&e.jsx("button",{type:"button",onClick:l,children:e.jsxs(Le,{direction:"column",alignItems:"stretch",gap:1,children:[e.jsx(Re,{}),e.jsx(f,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:y({id:u("button.component.add"),defaultMessage:"Add a component"})})]})}),e.jsx(x,{role:"tablist",gap:2,children:n.map((a,d)=>e.jsx(De,{dzName:s||"",index:d,component:a,isActive:p===d,isInDevelopmentMode:i,onClick:()=>g(d)},a))})]})}),e.jsx(Se,{children:n.map((a,d)=>{const c={customRowComponent:t,component:a};return e.jsx(m,{id:`dz-${s}-panel-${d}`,role:"tabpanel","aria-labelledby":`dz-${s}-tab-${d}`,style:{display:p===d?"block":"none"},children:e.jsx("table",{children:e.jsx("tbody",{children:L.createElement(de,{...c,isFromDynamicZone:!0,component:r,key:a})})})},a)})})]})})},Oe=h(m)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
...
`,Ve=t=>e.jsx(We,{children:e.jsx(ze,{width:"20",height:"23",viewBox:"0 0 20 23",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t,children:e.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.02477 14.7513C8.65865 17.0594 11.6046 18.6059 17.5596 18.8856C18.6836 18.9384 19.5976 19.8435 19.5976 20.9688V20.9688C19.5976 22.0941 18.6841 23.0125 17.5599 22.9643C10.9409 22.6805 6.454 20.9387 3.75496 17.1258C0.937988 13.1464 0.486328 7.39309 0.486328 0.593262H4.50974C4.50974 7.54693 5.06394 11.9813 7.02477 14.7513Z"})})}),Ue=({type:t,customField:n=null,repeatable:o=!1})=>{const{formatMessage:s}=A();let r=t;return["integer","biginteger","float","decimal"].includes(t)?r="number":["string"].includes(t)&&(r="text"),n?e.jsx(f,{children:s({id:u("attribute.customField"),defaultMessage:"Custom field"})}):e.jsxs(f,{textColor:"neutral800",children:[s({id:u(`attribute.${r}`),defaultMessage:t})," ",o&&s({id:u("component.repeatable"),defaultMessage:"(repeatable)"})]})},He=({content:t})=>e.jsx(e.Fragment,{children:ie(t)}),qe=h(m)`
  position: relative;
`,Ke=L.memo(({configurable:t=!0,customField:n=null,editTarget:o,firstLoopComponentUid:s=null,isFromDynamicZone:r=!1,name:i,onClick:p,relation:b="",repeatable:y=!1,secondLoopComponentUid:g=null,target:l=null,targetUid:a=null,type:d})=>{const{contentTypes:c,isInDevelopmentMode:M,removeAttribute:T}=D(),{formatMessage:$}=A(),C=d==="relation"&&b.includes("morph"),v=["integer","biginteger","float","decimal"].includes(d)?"number":d,F=j(c,[l],{}),R=j(F,["schema","displayName"],""),B=j(F,"plugin"),W=l?"relation":v,E=()=>{C||t!==!1&&p(o,g||s||a,i,d,n)};let k;return g&&s?k=2:s?k=1:k=0,e.jsxs(qe,{tag:"tr",onClick:M&&t&&!C?E:void 0,children:[e.jsxs("td",{style:{position:"relative"},children:[k!==0&&e.jsx(Ve,{color:r?"primary200":"neutral150"}),e.jsxs(x,{paddingLeft:2,gap:4,children:[e.jsx(Me,{type:W,customField:n}),e.jsx(f,{textColor:"neutral800",fontWeight:"bold",children:i})]})]}),e.jsx("td",{children:l?e.jsxs(f,{textColor:"neutral800",children:[$({id:u(`modelPage.attribute.${C?"relation-polymorphic":"relationWith"}`),defaultMessage:"Relation with"})," ",e.jsxs("span",{style:{fontStyle:"italic"},children:[e.jsx(He,{content:R})," ",B&&`(${$({id:u("from"),defaultMessage:"from"})}: ${B})`]})]}):e.jsx(Ue,{type:d,customField:n,repeatable:y})}),e.jsx("td",{children:M?e.jsx(x,{justifyContent:"flex-end",onClick:I=>I.stopPropagation(),children:t?e.jsxs(x,{gap:1,children:[!C&&e.jsx(te,{onClick:E,label:`${$({id:"app.utils.edit",defaultMessage:"Edit"})} ${i}`,variant:"ghost",children:e.jsx(se,{})}),e.jsx(te,{onClick:I=>{I.stopPropagation(),T(o,i,g||s||"")},label:`${$({id:"global.delete",defaultMessage:"Delete"})} ${i}`,variant:"ghost",children:e.jsx(ve,{})})]}):e.jsx($e,{})}):e.jsx(m,{height:"3.2rem"})})]})}),Ge=t=>{let n;switch(t){case"date":case"datetime":case"time":case"timestamp":n="date";break;case"integer":case"biginteger":case"decimal":case"float":n="number";break;case"string":case"text":n="text";break;case"":n="relation";break;default:n=t}return n},z={collectionTypesConfigurations:[{action:"plugin::content-manager.collection-types.configure-view",subject:null}],componentsConfigurations:[{action:"plugin::content-manager.components.configure-layout",subject:null}],singleTypesConfigurations:[{action:"plugin::content-manager.single-types.configure-view",subject:null}]},Je=({isInContentTypeView:t,contentTypeKind:n})=>t?n==="singleType"?z.singleTypesConfigurations:z.collectionTypesConfigurations:z.componentsConfigurations,Qe=L.memo(({disabled:t,isInContentTypeView:n=!0,contentTypeKind:o="collectionType",targetUid:s=""})=>{const{formatMessage:r}=A(),i=je(),p=Je({isInContentTypeView:n,contentTypeKind:o}),b=r({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),y=()=>(t||i(n?`/content-manager/collection-types/${s}/configurations/edit`:`/content-manager/components/${s}/configurations/edit`),!1),{isLoading:g,allowedActions:l}=Ce({viewConfig:p});return g||!l.canConfigureView&&!l.canConfigureLayout?null:e.jsx(N,{startIcon:e.jsx(we,{}),variant:"tertiary",onClick:y,disabled:t,children:b})}),Xe=h(ae.Header)`
  overflow-wrap: anywhere;
`,lt=()=>{const{initialData:t,modifiedData:n,isInDevelopmentMode:o,isInContentTypeView:s,submitData:r}=D(),{formatMessage:i}=A(),{trackUsage:p}=oe(),b=ge("/plugins/content-type-builder/:kind/:currentUID"),{onOpenModalAddComponentsToDZ:y,onOpenModalAddField:g,onOpenModalEditField:l,onOpenModalEditSchema:a,onOpenModalEditCustomField:d}=re(),c=s?"contentType":"component",M=[c,"schema","attributes"],T=j(n,[c,"uid"]),$=j(n,[c,"isTemporary"],!1),C=j(n,[c,"schema","kind"],null),v=j(n,M,[]),F=fe(t,[c,"plugin"]),R=!G(n,t),B=s?"contentType":"component",W=w=>{y({dynamicZoneTarget:w,targetUid:T})},E=async(w,V,U,H,q)=>{const K=Ge(H);q?d({forTarget:w,targetUid:V,attributeName:U,attributeType:K,customFieldUid:q}):l({forTarget:w,targetUid:V,attributeName:U,attributeType:K,step:H==="component"?"2":null})};let k=j(n,[c,"schema","displayName"],"");const I=j(n,[c,"schema","kind"],""),O=b?.params.currentUID==="create-content-type";!k&&O&&(k=i({id:u("button.model.create"),defaultMessage:"Create new collection type"}));const ue=()=>{const w=I||c;w==="collectionType"&&p("willEditNameOfContentType"),w==="singleType"&&p("willEditNameOfSingleType"),a({modalType:c,forTarget:c,targetUid:T,kind:w})};xe({when:R,message:i({id:u("prompt.unsaved"),defaultMessage:"Are you sure?"})});const he=o&&e.jsxs(x,{gap:2,marginLeft:2,children:[!O&&e.jsx(N,{startIcon:e.jsx(S,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{g({forTarget:B,targetUid:T})},children:i({id:u("button.attributes.add.another"),defaultMessage:"Add another field"})}),e.jsx(N,{startIcon:e.jsx(ye,{}),onClick:async()=>await r(),type:"submit",disabled:G(n,t),children:i({id:"global.save",defaultMessage:"Save"})})]}),me=o&&!F&&!O&&e.jsx(N,{startIcon:e.jsx(se,{}),variant:"tertiary",onClick:ue,children:i({id:"app.utils.edit",defaultMessage:"Edit"})});return e.jsxs(e.Fragment,{children:[e.jsx(Xe,{id:"title",primaryAction:he,secondaryAction:me,title:ie(k),subtitle:i({id:u("listView.headerLayout.description"),defaultMessage:"Build the data architecture of your content"}),navigationAction:e.jsx(be,{})}),e.jsx(ae.Content,{children:e.jsxs(x,{direction:"column",alignItems:"stretch",gap:4,children:[e.jsx(x,{justifyContent:"flex-end",children:e.jsx(x,{gap:2,children:e.jsx(Qe,{targetUid:T,isInContentTypeView:s,contentTypeKind:C,disabled:O||$},"link-to-cm-settings-view")})}),e.jsx(m,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,children:e.jsx(pe,{items:v,customRowComponent:w=>e.jsx(Ke,{...w,onClick:E}),addComponentToDZ:W,targetUid:T,editTarget:B,isMain:!0})})]})})]})};export{lt as default};
